---
title: "<<date>>: Epidemic Map for <<method-zh>> (Covid-19)"
date: <<date>>
...
[Click here for full screen display.](https://pzhaonet.github.io/ncov/leaflet/leafmap-<<method>>-<<date>>.html)
...
```{r, results='asis'}
cat("## <<date>> Epidemic Data Sheet (", "<<method-zh>>", ")")
```
