---
title: "2020-03-16: Epidemic Map for countries (Covid-19)"
date: 2020-03-16
slug: country-map-2020-03-16
---
...
<iframe seamless src="https://pzhaonet.github.io/ncov/leaflet/leafmap-country-2020-03-16.html" width="100%" height="500"></iframe>

Confirmed cases. The gray area in the figure indicates the lack of relevant data or 0 case in this area.

[Click here for full screen display.](https://pzhaonet.github.io/ncov/leaflet/leafmap-country-2020-03-16.html)
...
ncov_raw$area <- ncov_raw$area[ncov_raw$area$date <= as.Date("2020-03-16"), ]
x_ts <- ncov_raw$area
...
if(method == 'city'){
  ...
  x_city <- x_city[as.Date(x_city$date) <= as.Date("2020-03-16"), ]
...
```{r, results='asis'}
cat("## 2020-03-16 Epidemic Data Sheet (", "countries", ")")
```
...
```{r, results='asis'}
if(method == "country" & as.Date("2020-03-16") == max(ncov_raw$area$date, na.rm = TRUE)){
