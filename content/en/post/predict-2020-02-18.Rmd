---
title: "2020-02-18: Epidemic Mitigation Time Forecast (Covid-19)"
date: 2020-02-18
...
```{r, results='asis'}
cat("## 2020-02-18 Epidemic forecast by province")
```
...
for(x in Prov) {
  ...
  predict_date(province = x, ncov = ncov, ifplot = TRUE, ifchinese = FALSE, predDate = as.Date('2020-02-18'))
  cat("  \n")
}
```
