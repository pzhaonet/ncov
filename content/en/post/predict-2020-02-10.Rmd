...
PredDate <- format(as.Date('2020-02-10'),"%m-%d") #*****Set the date you want to predict
...
for(x in Prov) {
  ...
  predict_date(province = x, ncov = ncov, ifplot = TRUE, ifchinese = FALSE, predDate = as.Date('2020-02-10'))
  cat("  \n")
}
```
