---
title: "2020-03-03: Epidemic Mitigation Time Forecast (Covid-19)"
date: 2020-03-03
...
```{r, results='asis'}
cat("## 2020-03-03 Epidemic forecast by province")
```
...
for(x in Prov) {
  ...
  predict_date(province = x, ncov = ncov, ifplot = TRUE, ifchinese = FALSE, predDate = as.Date('2020-03-03'))
  cat("  \n")
}
```
