---
title: 2020-02-01: Epidemic Map for provinces (2019-nCoV)
date: 2020-02-01
...
[Click here for full screen display.](https://pzhaonet.github.io/ncov/leaflet/leafmap-province-2020-02-01.html)
...
if(method == 'city'){
  ...
  x_city <- x_city[as.Date(x_city$date) <= as.Date("2020-02-01"), ]
...
```{r, results='asis'}
cat("## 2020-02-01 Epidemic Data Sheet (", prefix, ")")
```
