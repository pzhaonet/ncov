...
<iframe seamless src="https://pzhaonet.github.io/ncov/leaflet/leafmap-country-2020-03-19.html" width="100%" height="500"></iframe>

Confirmed cases. The gray area in the figure indicates the lack of relevant data or 0 case in this area.

[Click here for full screen display.](https://pzhaonet.github.io/ncov/leaflet/leafmap-country-2020-03-19.html)
...
ncov_raw$area <- ncov_raw$area[ncov_raw$area$date <= as.Date("2020-03-19"), ]
x_ts <- ncov_raw$area
...
if(method == 'city'){
  ...
  x_city <- x_city[as.Date(x_city$date) <= as.Date("2020-03-19"), ]
...
```{r, results='asis'}
cat("## 2020-03-19 Epidemic Data Sheet Top 10 Countries)")
```
...
```{r, results='asis'}
if(method == "country" & as.Date("2020-03-19") == max(ncov_raw$area$date, na.rm = TRUE)){
