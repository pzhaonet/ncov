---
title: "2020-03-05: Epidemic Map for provinces (Covid-19)"
date: 2020-03-05
slug: province-map-2020-03-05
---
...
<iframe seamless src="https://pzhaonet.github.io/ncov/leaflet/leafmap-province-2020-03-05.html" width="100%" height="500"></iframe>

Confirmed cases. The gray area in the figure indicates the lack of relevant data or 0 case in this area.

[Click here for full screen display.](https://pzhaonet.github.io/ncov/leaflet/leafmap-province-2020-03-05.html)
...
ncov_raw$area <- ncov_raw$area[ncov_raw$area$date <= as.Date("2020-03-05"), ]
x_ts <- ncov_raw$area
...
if(method == 'city'){
  ...
  x_city <- x_city[as.Date(x_city$date) <= as.Date("2020-03-05"), ]
...
```{r, results='asis'}
cat("## 2020-03-05 Epidemic Data Sheet (", "provinces", ")")
```
...
```{r, results='asis'}
if(method == "country" & as.Date("2020-03-05") == max(ncov_raw$area$date, na.rm = TRUE)){
