---
title: "2020-01-26: Epidemic Map for provinces (2019-nCoV)"
date: 2020-01-26
slug: province-map-2020-01-26
---
...
<iframe seamless src="https://pzhaonet.github.io/ncov/leaflet/leafmap-province-2020-01-26.html" width="100%" height="500"></iframe>

Confirmed cases. The gray area in the figure indicates the lack of relevant data of the cities in this area.

[Click here for full screen display.](https://pzhaonet.github.io/ncov/leaflet/leafmap-province-2020-01-26.html)
...
ncov$area <- ncov$area[ncov$area$date <= as.Date("2020-01-26"), ]
...
if(method == 'city'){
  ...
  x_city <- x_city[as.Date(x_city$date) <= as.Date("2020-01-26"), ]
...
```{r, results='asis'}
cat("## 2020-01-26 Epidemic Data Sheet (", prefix, ")")
```
