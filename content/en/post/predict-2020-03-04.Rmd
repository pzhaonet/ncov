---
title: "2020-03-04: Epidemic Mitigation Time Forecast (Covid-19)"
date: 2020-03-04
...
```{r, results='asis'}
cat("## 2020-03-04 Epidemic forecast by province")
```
...
for(x in Prov) {
  ...
  predict_date(province = x, ncov = ncov, ifplot = TRUE, ifchinese = FALSE, predDate = as.Date('2020-03-04'))
  cat("  \n")
}
```
