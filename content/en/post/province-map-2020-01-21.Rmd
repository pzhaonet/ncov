---
title: "2020-01-21: Epidemic Map for provinces (2019-nCoV)"
date: 2020-01-21
...
[Click here for full screen display.](https://pzhaonet.github.io/ncov/leaflet/leafmap-province-2020-01-21.html)
...
ncov$area <- ncov$area[ncov$area$date <= as.Date("2020-01-21"), ]
...
if(method == 'city'){
  ...
  x_city <- x_city[as.Date(x_city$date) <= as.Date("2020-01-21"), ]
...
```{r, results='asis'}
cat("## 2020-01-21 Epidemic Data Sheet (", prefix, ")")
```
