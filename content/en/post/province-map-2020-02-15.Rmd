---
title: "2020-02-15: Epidemic Map for provinces (Covid-19)"
date: 2020-02-15
slug: province-map-2020-02-15
---
...
<iframe seamless src="https://pzhaonet.github.io/ncov/leaflet/leafmap-province-2020-02-15.html" width="100%" height="500"></iframe>

Confirmed cases. The gray area in the figure indicates the lack of relevant data of the cities in this area.

[Click here for full screen display.](https://pzhaonet.github.io/ncov/leaflet/leafmap-province-2020-02-15.html)
...
if(method == 'city'){
  ...
  x_city <- x_city[as.Date(x_city$date) <= as.Date("2020-02-15"), ]
...
```{r, results='asis'}
cat("## 2020-02-15 Epidemic Data Sheet (", prefix, ")")
```
