...
```{r}
knitr::kable(df_predict[!is.na(df_predict$enddate), c(6, 1, 2, 5, 4)], format = "html", row.names = FALSE, col.names = c("Area", "Area_cn", "Epidemic Mitigation Time", paste(tomorrow, "Predicted daily increase in confirmed"), paste(tomorrow, " Predicted confirmed in total")))
```
