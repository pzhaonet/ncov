---
title: "2020-02-05: Epidemic Mitigation Time Forecast (Covid-19)"
date: 2020-02-05
...
PredDate <- format(as.Date('2020-02-05'),"%m-%d") #*****Set the date you want to predict
...
for(x in Prov) {
  ...
  predict_date(province = x, ncov = ncov, ifplot = TRUE, ifchinese = FALSE, predDate = as.Date('2020-02-05'))
  cat("  \n")
}
```
