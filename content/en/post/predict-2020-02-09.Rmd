---
title: 2019-nCoV Epidemic Mitigation Time Forecast (2020-02-09)
date: 2020-02-09
...
```{r}
knitr::kable(df_predict[!is.na(df_predict$enddate), c(6, 1, 2, 5, 4)], format = "html", row.names = FALSE, col.names = c("[Area]", '[Area_cn]', "[Epidemic Mitigation Time]", paste0("[", tomorrow, " Prdctd daily incrs conf.]"), paste0("[", tomorrow, " Prdctd conf. in total]")))
```

```{r, results='asis'}
for(x in unique(ncov$area$provinceShortName[ncov$area$country == '中国'])) {
