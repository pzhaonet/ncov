---
title: 2020-02-11: 省级疫情地图 (2019-nCoV)
date: 2020-02-11
...
[点击这里全屏显示。](https://pzhaonet.github.io/ncov/leaflet/leafmap-province-2020-02-11.html)
...
```{r, results='asis'}
cat("## 2020-02-11 疫情数据表(", prefix, ")")
```

```{r}
# knitr::kable(x, format = "html", row.names = FALSE, col.names = c("排序", "名称", "确诊", "治愈", "死亡"))
flextable::flextable(x, col_keys = c("排序", "名称", "确诊", "治愈", "死亡"))
```
