---
title: 2019-nCoV 疫情缓和时间预测(2020-01-31)
date: 2020-01-31
slug: predict-2020-01-31
---
...
ncovChina <- ncovChina[ncovChina[, "日期"] <= as.Date('2020-01-31'), ]
```
...
knitr::kable(ncovChina[-1, 1:9], format = "html", row.names = FALSE)
```
