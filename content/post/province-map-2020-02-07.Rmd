---
title: 2019-nCoV 疫情地图(省级)2020-02-07
date: 2020-02-07
...
[点击这里全屏显示。](https://pzhaonet.github.io/ncov/leaflet/leafmap-province-2020-02-07.html)
...
x <- ncov$area[ncov$area$date == "2020-02-07", c(2, 3, 5, 6)]

method <- "province"

if(method == 'city'){
  x_city <- dplyr::bind_rows(ncov$area$cities[ncov$area$date == "2020-02-07"])
  names(x)[1] <- "cityName"
