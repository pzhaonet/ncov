---
title: 2019-nCoV Epidemic Mitigation Time Forecast (<<date>>)
date: <<date>>
slug: predict-<<date>>
---
...
df_predict$area_en[df_predict$area == '香港'] <- 'Hong Kong'
df_predict$area_en[df_predict$area == '澳门'] <- 'Macau'
df_predict$area_en[df_predict$area == '台湾'] <- 'Taiwan'
...
```{r}
knitr::kable(df_predict[!is.na(df_predict$enddate), c(6, 2, 5, 4)], format = "html", row.names = FALSE, col.names = c("Area", "Epidemic Mitigation Time", paste0(tomorrow, "Daily increase in confirmed"), paste0(tomorrow, "Confirmed in total")))
```
